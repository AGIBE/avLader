...
def get_config(subcommand):
    ...
    config['GEODB_VEK2']['connection_file'] = avLader.helpers.connection_helper.create_connection_files(config, 'GEODB_VEK2', logger)
    config['GEO_VEK1']['connection_file'] = avLader.helpers.connection_helper.create_connection_files(config, 'GEO_VEK1', logger)
