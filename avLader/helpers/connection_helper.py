...
def delete_connection_files(config, logger):
    delete_connection_file(config['AV01_WORK']['connection_file'], logger)
    delete_connection_file(config['GEODB_DD_TEAM']['connection_file'], logger)
    delete_connection_file(config['NORM_TEAM']['connection_file'], logger)

def delete_connection_file(connection_file, logger):
